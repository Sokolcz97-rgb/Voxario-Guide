...
function VG:CreateGuideSelector()
    ...
    function frame:Refresh()
        ...
        for index, guide in ipairs(guides) do
            ...
            row.meta:SetText(truncate((guide.faction or VG:T("DEVELOPMENT")) .. " | " .. (guide.category or "guide") .. " | " .. range .. " | " .. label .. ((availability == "unavailable" or availability == "overleveled") and (" - " .. tostring(reason)) or ""), 66))
