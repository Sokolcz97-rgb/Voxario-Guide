...
function VG:CreateGuideSelector()
    ...
    function frame:Refresh()
        ...
        for index, guide in ipairs(guides) do
            ...
            local minimum, maximum = tonumber(guide.minLevel), tonumber(guide.maxLevel)
            local range = minimum and maximum and string.format("Level %d-%d", minimum, maximum) or "Level range unknown"
