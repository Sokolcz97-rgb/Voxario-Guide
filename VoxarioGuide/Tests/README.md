...
- Confirm login produces no Lua errors and the faction-appropriate development guide is offered.
- Test `/vg`, `/vg guides`, `/vg reset`, `/vg debug`, `/vg status`, and `/vg version`.
