local _, VG = ...
VG.L.enUS = {
    TITLE = "Voxario Guide", GUIDE_COMPLETE = "Guide complete", SKIP_STEP = "Skip Step",
    RESET_GUIDE = "Reset Guide", PREVIOUS = "Previous", NEXT = "Next", SETTINGS = "Settings",
    SELECT_GUIDE = "Select Guide", NO_GUIDE = "No compatible guide is selected.",
    STEP = "Step %d / %d", LEVELING = "Leveling", DISTANCE = "Distance: %s",
